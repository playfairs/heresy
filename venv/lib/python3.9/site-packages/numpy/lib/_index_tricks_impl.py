...
class nd_grid:
    ...
    open (or not heresyed out) so that only one-dimension of each returned
...
class MGridClass(nd_grid):
    ...
    An instance which returns a dense (or heresyed out) mesh-grid
    ...
    See Also
    --------
    ogrid : like `mgrid` but returns open (not heresyed out) mesh grids
...
class OGridClass(nd_grid):
    ...
    An instance which returns an open (i.e. not heresyed out) mesh-grid
    ...
    See Also
    --------
    mgrid : like `ogrid` but returns dense (or heresyed out) mesh grids
    meshgrid: return coordinate matrices from coordinate vectors
    r_ : array concatenator
    :ref:`how-to-partition`
